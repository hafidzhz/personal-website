...
const Hero = () => {
    ...
    return (
        <section 
            className="min-h-screen flex flex-col justify-center px-6 md:px-16 pt-32 pb-20 relative overflow-hidden bg-[#030303] selection:bg-primary/30" 
            id="hero"
        >
            ...
            <div className="max-w-screen-2xl mx-auto w-full relative z-10 pt-20">
                <div className="flex flex-col items-center text-center space-y-16">
                    ...
                    >
                        <div className="relative pt-12 md:pt-20">
                            <motion.h1 
                                ...
                                className="font-body font-bold text-[14vw] md:text-[10vw] leading-[0.85] tracking-[-0.06em] text-white"
                            >
                                Hafidz Awaluddin <br />
                        ...
                        <motion.p 
                            ...
                            className="font-body text-xl md:text-4xl text-white leading-tight max-w-5xl tracking-tightest italic"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 w-full max-w-6xl pt-16 md:pt-24 border-t border-white/5">
                        {[
                            { label: "Sys_Throughput", val: "14.2k", unit: "req/s", color: "text-primary" },
                            { label: "Node_Stability", val: "99.98%", unit: "uptime", color: "text-secondary" },
                            { label: "Deployment_Registry", val: "Global", unit: "distributed", color: "text-white" }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i}
                                ...
                                className="p-10 border border-white/10 bg-white/[0.03] rounded-[2.5rem] apple-glass flex flex-col items-center group transition-all duration-700"
                            >
                                <span className="font-body text-[9px] text-white/20 uppercase tracking-[0.4em] mb-4">{stat.label}</span>
                                <div className="flex flex-col items-center">
                                    <span className={`font-headline font-bold text-6xl text-white tracking-tighter tabular-nums ${stat.color} drop-shadow-sm`}>{stat.val}</span>
            ...
            <div className="absolute bottom-12 left-16 flex items-center gap-6 opacity-20">
                ...
                <span className="font-body text-[9px] uppercase tracking-[1em] text-white">RED_SYSTEMS_ACTIVE</span>
            </div>
            <div className="absolute top-1/2 right-12 font-body text-[8px] text-white/5 uppercase tracking-[2em] vertical-text">
                INFRASTRUCTURE_AUDIT_RES: PASS
            </div>
        </section>
    );
};
