...
const TechCard = ({ item, i }) => {
    return (
        <GlassCard 
            tilt={true}
            className="group relative min-h-[180px] md:min-h-[220px] flex flex-col justify-between p-8 md:p-12 transition-all duration-700 cursor-default rounded-[2.5rem] md:rounded-[3rem] border-white/5"
        >
