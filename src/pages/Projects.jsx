...
const ArchiveRow = ({ project, index, isLast }) => {
    return (
        <motion.div
            ...
            className={`group relative py-20 md:py-24 px-12 md:px-24 hover:bg-white/[0.03] transition-all duration-700 ${!isLast ? 'border-b border-white/5' : ''}`}
        >
            <Link to={`/projects/${project.id}`} className="flex flex-col lg:grid lg:grid-cols-12 gap-12 items-start lg:items-center">
                <div className="lg:col-span-8 space-y-10 relative z-10">
                    <div className="flex items-center gap-6">
                        ...
                        <span className="font-body text-[10px] text-white/20 uppercase tracking-[0.5em]">{project.date}</span>
                    </div>
                    
                    <div className="space-y-4">
                        <h3 className="font-body font-semibold text-5xl md:text-6xl text-white tracking-tightest leading-none group-hover:text-primary transition-colors">
                            {project.title}
                        </h3>
                ...
                <div className="lg:col-span-4 flex flex-col items-start lg:items-end text-left lg:text-right space-y-4 self-center">
                    ...
                    <div className="flex flex-col items-start lg:items-end">
                        <span className="font-body font-bold text-6xl md:text-7xl text-white tracking-tighter leading-none tabular-nums">{project.stats}</span>
    ...
    return (
        <div className="min-h-screen bg-[#030303] selection:bg-primary/20 overflow-x-hidden">
            ...
            <div className="max-w-screen-2xl mx-auto px-6 md:px-24 relative z-10">
                <header className="pt-64 md:pt-80 pb-32 md:pb-64 relative">
                    <div className="flex flex-col items-start gap-12">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-8 overflow-hidden">
                                ...
                                <span className="font-body text-xs text-primary/60 uppercase tracking-[0.8em]">Operational_Archives</span>
                            </div>
                            ...
                            <div className="flex items-center gap-4 opacity-40">
                                <span className="font-body text-sm text-white/40 tracking-[0.4em] uppercase italic">Archive Registry // 19—26</span>
                            </div>
                        </div>

                        <div className="mt-20 flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-16">
                            <p className="font-body text-2xl md:text-3xl text-white/40 max-w-2xl italic leading-snug">
                            ...
                            <div className="space-y-4 md:text-right border-l md:border-l-0 md:border-r border-white/10 pl-8 md:pl-0 md:pr-8 py-2">
                                 <span className="font-body text-[10px] text-secondary uppercase tracking-[0.6em] block opacity-40 italic">Registry_Status</span>
                ...
                <div className="apple-glass rounded-[4rem] border-white/5 relative overflow-hidden mb-80">
